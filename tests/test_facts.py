...
class FactsTest(unittest.TestCase):
    ...
    def test_clean_prompt_strips_in_app_browser_context(self) -> None:
        prompt = "\n".join(
            [
                "# In app browser:",
        ...
        self.assertEqual(clean_prompt(prompt, 220), "Build the dashboard")
    ...
    def test_new_prompt_makes_older_completion_pending(self) -> None:
        rows = [
            row("thread-a", "/tmp/project-a", "2026-06-08T01:00:00+00:00", "user_message", "build it"),
            row("thread-a", "/tmp/project-a", "2026-06-08T01:05:00+00:00", "task_complete", "Built it"),
            row("thread-a", "/tmp/project-a", "2026-06-08T01:10:00+00:00", "user_message", "review it"),
        ]
